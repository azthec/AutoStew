...
from clients.bitbucket import TypedBucket
...
def main():
    ...
    bitbucket = TypedBucket.from_token(bitbucket_config.url, bitbucket_config.username, bitbucket_config.token)
    bitbucket.project_list()[0]
